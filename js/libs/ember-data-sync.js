...
DS.SyncStore = DS.Store.extend(DS._ModifiedRecordsHelpers, {
  ...
  createPendingUpSyncRecord: function(transaction, kind, record) {
    console.log('createPendingUpSyncRecord');
  ...
  _initialize: function() {
    ...
    get(this, 'serverStore')._setServerOptions(serverOptions);
...
Ember.onLoad('Ember.Application', function(Application) {
  Ember.Application.initializer({
    ...
    initialize: function(app, stateManager) {
      ...
      //if (property === 'Store') {
        ...
        serverStore.setProperties(serverOptions);
        serverAdapter.setProperties(serverOptions);
